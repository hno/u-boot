...
#if defined(CONFIG_SUNXI_AXP238)
        if(axp238_probe())
        {
            printf("probe axp238 failed\n");
        }
        else
        {
            /* pmu type AXP238 */
            tick_printf("PMU: AXP238 found\n");
            ret ++;
        }
        sunxi_axp_dev[PMU_TYPE_238] = &sunxi_axp_238;
#if (CONFIG_SUNXI_AXP_MAIN == PMU_TYPE_238)
        sunxi_axp_dev[0] = &sunxi_axp_238;
#endif
#endif
